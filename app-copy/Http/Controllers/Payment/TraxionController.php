...
class TraxionController extends Controller
{
    ...
    public function generate_link(Request $req)
    {
        try{
            ...
            "billing_remark"            => "N/A",
            "payment_method"            => "",
            // 'status_notification_url'   => 'https://c89e22f25708.ngrok.io/booking/public/api/payment/status/callback?details='.$bookDetailsss.'&cn='.$req->proid.'&extra='.$extraData.'&contact='.$contactData,
