...
<div class="col-lg-9">
  <form action="{{ route('profile-update',$account->name) }}" method="post" role="form" class="cls-profile">
  ...
  <div class="row row-margin">
    ...
    <input type="text" class="uk-input" name="companyname" id="companyname" value="{{ $account->name }}" placeholder="Display Name">
    <div class="validate"></div>
    </div>

    <div class="col-md-4 form-group mt-3">
    <label class="labelcoz">First Name</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="First Name">
    <div class="validate"></div>
    </div>

    <div class="col-md-4 form-group mt-3">
    <label class="labelcoz">Last Name</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Last Name">
    <div class="validate"></div>
    </div>

    <div class="col-md-4 form-group mt-3">
    <label class="labelcoz">Middle Name</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Middle Name">
    <div class="validate"></div>
    </div>

    <div class="col-md-6 form-group mt-4">
    <label class="labelcoz">Gender</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Gender">
    <div class="validate"></div>
    </div>

    <div class="col-md-6 form-group mt-4">
    <label class="labelcoz">Birthdate</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Birthdate">
    <div class="validate"></div>
    </div>
    ...
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Country">
    <div class="validate"></div>
    </div>

    <div class="col-md-4 form-group mt-3">
    <label class="labelcoz">Phone Number</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Phone Number">
    <div class="validate"></div>
    </div>

    <div class="col-md-4 form-group mt-3">
    <label class="labelcoz">Email</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Email">
    <div class="validate"></div>
    </div>

    <div class="col-md-12 form-group mt-3">
    <label class="labelcoz">Address</label>
    <input type="text" class="uk-input" name="companyname" id="companyname" value="" placeholder="Address">
    <div class="validate"></div>
    </div>
