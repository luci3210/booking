...
<div class="section-title">
  <h2><b>Top Provice Destination </b><span style="font-size: 15px;padding-left: 25px;"><a href="{{ route('destination') }}" class="uk-link"> View All</a></span></h2>
</div>
