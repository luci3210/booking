...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Update Cover</li>
    </ol>
    </nav>
    </div>
  </div>
    ...
    <div class="card card-default mt-3">
      ...
      <div class="card-body">
        ...
        <div class="text-center mt-4">
          <img src="{{ asset('image/cover/2021')}}/{{ $data->cover == '' ? 'default.png' : $data->cover }}" alt=""  style="border-radius: 12px; width:auto; height:200px;border:4px solid #CCD1D1;">
        </div>
    ...
    <div class="card card-default mt-3">
      ...
      <div class="card-body">
        ...
        <dl>
          ...
          <button type="submit" class="btn btn-info mt-4">More Details <i class="fas fa-chevron-circle-right"></i></button>
